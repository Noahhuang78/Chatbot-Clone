...
with open('perf_time.jsonl', 'a', encoding='utf-8') as f:
    json.dump({'name': "Qwen/Qwen3-Embedding-0.6B ", 'perf_time': elapsed_time}, f , ensure_ascii=False)
    f.writes("\n")

with open(f'Qwen3_similarities.json', 'w', encoding='utf-8') as f:
