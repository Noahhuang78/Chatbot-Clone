...
with open('perf_time.jsonl', 'a', encoding='utf-8') as f:
    json.dump({'name': "sentence-transformers/all-MiniLM-L12-v2 ", 'perf_time': elapsed_time}, f , ensure_ascii=False)

with open(f'MiniLM-L12_similarities.json', 'w', encoding='utf-8') as f:
...
#average for MiniLM-L12 is 0.844
